...
2. ✅ **Resuelto — centros de pasos reasignados por tests**: antes del aislamiento, el helper de `motor.spec.ts` había apuntado todos los pasos de config sin máquina (T-1/T-2/T-4) a VP-002 (40 pasos). El 2026-07-10 se reasignaron a mano desde el editor de pasos a sus centros correctos.

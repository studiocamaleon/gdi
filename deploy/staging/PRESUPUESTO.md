...
2. La compilación/arranque de API/Next y el login HTTP directo/BFF ya aprobaron en un ejecutor estándar de GitHub, sin reiniciar Docker de esta Mac; ver [VALIDACION.md](./VALIDACION.md). Falta el recorrido en navegador y las pruebas cloud. No crear un builder pago sin contemplar su costo.

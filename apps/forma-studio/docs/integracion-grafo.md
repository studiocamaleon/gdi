...
La decisión comercial vigente es ofrecer Grafo3D gratis en la web de Grafoprint,
sin cuentas ni facturación propias. La eventual conexión al motor utilizará la
sesión y la empresa de Grafo para aplicar sus permisos y costos. El editor público
seguirá funcionando de forma independiente. Esa integración no está implementada
en la publicación inicial de `/3d`.

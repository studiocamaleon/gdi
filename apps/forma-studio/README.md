...
## Herramienta pública gratuita

Grafo3D está integrado en la web comercial bajo **`/3d`**, sin registro ni
suscripción. La publicación al dominio todavía está pendiente del primer
despliegue de la web. El proceso de instalación y build está documentado en
[`../marketing/README.md`](../marketing/README.md#grafo3d-en-el-mismo-dominio).
La portada y su menú enlazan al editor completo. El cálculo local es orientativo;
la conexión autenticada al motor de costos de cada empresa sigue pendiente.
...
- Once construcciones disponibles: frente acrílico, fondo abierto, doble apoyo, apoyo único, encastre trasero, retroiluminada, acrílico encastrable, frente impreso, frente calado, letra curva y Especiales. Doble iluminación y Canal neón están retirados del selector; se conserva la compatibilidad con proyectos guardados.
- Controles específicos por modelo: paredes, apoyos triangulares o planos, bordes, retrocesos, holguras, pestaña exterior, tapas desmontables, bandeja con retención y barrido angular con base unida o encastrable. Los parámetros se conservan al cambiar de estilo.
...
- Frente calado con difusor acrílico interno y las seis bases nuevas: círculos, diamantes, cuadrados, hexágonos, oblongos y triángulos; tamaño, separación, borde protegido y rotaciones independientes. Calado real en el STL y difusor entero en DXF/SVG. Ver `docs/frente-calado.md`.
- Siete perfiles de Especiales: Pliegues, Arco, Transición, Acanalado, Zócalo, Cúpula y Estratos. Los mismos nombres se usan en los relieves de las banderolas y conservan sus identificadores internos para abrir proyectos anteriores. Frente acrílico o impreso, sólido o cascarón, fijación frontal o trasera, fondo impreso/PVC y sección del perfil visible.
- Visor 3D con órbita, zoom, vistas, cuadrícula, colores, visibilidad y despiece. Precisión de profundidad ajustada al zoom y once miniaturas de cortes 3D generadas con geometría propia: un bloque biselado muestra paredes, apoyos y tapas; Letra curva utiliza un ejemplo de texto.
...
La herramienta pública gratuita no requiere cuentas, suscripciones ni facturación propias. El guardado en la nube y la vinculación con una empresa de Grafo quedan para una etapa posterior. Todavía no hay una llamada activa a la API de Grafo: el contrato de integración está listo para implementar el adaptador autenticado descrito en `docs/integracion-grafo.md`.

...
import { SPECIAL_PROFILE_LABELS } from "../core/profile-labels";
import {
  FitComponentEditor,
      ...
      {id === "organic" && (
        <>
          <Section title="Perfil de la pared">
            <FieldGroup>
              {choice("organicProfile", "Forma del perfil", Object.entries(SPECIAL_PROFILE_LABELS))}
              ...
              {v.organicProfile === "belly" &&
                n("organicBelly", "Profundidad del arco", -15, 15)}
              ...
              {v.organicProfile === "stack" && (
                <>
                  {n("organicCount", "Cantidad de estratos", 1, 6, "", 1)}
                  {n("organicStackAdvance", "Avance del estrato", 0.3, 6)}
                  {n("organicStackGap", "Espacio entre estratos", 0, 30)}

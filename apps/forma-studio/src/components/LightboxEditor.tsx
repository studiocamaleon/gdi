  ...
  return <div className="component-editor">
    ...
    <Section title="Lateral exterior"><FieldGroup>
      ...
      {v.sideProfile!=="smooth"&&<>
        ...
        {v.sideProfile==="stack"&&<>{n("sideCount","Cantidad de estratos",1,12,1,"")}{n("sideGap","Separación entre estratos",0,10)}</>}
        {v.sideProfile==="bumper"&&n("sideFoot","Tramo recto del zócalo",0,60)}

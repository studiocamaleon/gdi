...
const CATALOGO_SUGERIDO: Array<{
  ...
  { codigo: 'efectivo', nombre: 'Efectivo', tipo: 'efectivo', comisionPct: 0, ivaComisionPct: 0, plazoAcreditacionDias: 0, sufreRetencion: false, cuentaSugerida: { nombre: 'Caja mostrador', tipo: 'caja' } },
  { codigo: 'transferencia', nombre: 'Transferencia', tipo: 'transferencia', comisionPct: 0, ivaComisionPct: 0, plazoAcreditacionDias: 0, sufreRetencion: true },
  { codigo: 'qr_30', nombre: 'QR 3.0', tipo: 'billetera_qr', comisionPct: 0.8, ivaComisionPct: 21, plazoAcreditacionDias: 1, sufreRetencion: true },
  { codigo: 'debito', nombre: 'Débito', tipo: 'tarjeta_debito', comisionPct: 1.8, ivaComisionPct: 21, plazoAcreditacionDias: 2, sufreRetencion: true },
  { codigo: 'credito_1_pago', nombre: 'Crédito 1 pago', tipo: 'tarjeta_credito', comisionPct: 3.5, ivaComisionPct: 21, plazoAcreditacionDias: 10, sufreRetencion: true },
  { codigo: 'credito_cuotas', nombre: 'Crédito en cuotas', tipo: 'tarjeta_credito', comisionPct: 5.2, ivaComisionPct: 21, plazoAcreditacionDias: 10, sufreRetencion: true },
  { codigo: 'mp_por_canal', nombre: 'MP por canal', tipo: 'billetera_qr', comisionPct: 4.99, ivaComisionPct: 21, plazoAcreditacionDias: 0, sufreRetencion: true },
  { codigo: 'echeq', nombre: 'Echeq', tipo: 'cheque_echeq', comisionPct: 0, ivaComisionPct: 0, plazoAcreditacionDias: 30, sufreRetencion: false, cuentaSugerida: { nombre: 'Cartera de valores', tipo: 'cartera_valores' } },
  { codigo: 'debin', nombre: 'DEBIN', tipo: 'debito_automatico', comisionPct: 0.6, ivaComisionPct: 21, plazoAcreditacionDias: 1, sufreRetencion: true },
];

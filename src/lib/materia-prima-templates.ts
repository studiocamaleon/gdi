...
export const materiaPrimaTemplatesV1: MateriaPrimaTemplateDef[] = [
  ...
  },
  {
    ...
    unidadCompra: "pack",
    camposTecnicos: [
      { key: "formatoComercial", label: "Formato comercial", type: "text", required: true },
      { key: "ancho", label: "Ancho", type: "number", unit: "mm", required: true },
      { key: "alto", label: "Alto", type: "number", unit: "mm", required: true },
      { key: "margenNoUsable", label: "Margen no usable", type: "number", unit: "mm", required: true },
      { key: "espesor", label: "Espesor (micrones)", type: "number", required: true },
    ],
    dimensionesVariante: ["formatoComercial", "ancho", "alto", "espesor"],
    requiredAtributos: ["formatoComercial", "ancho", "alto", "margenNoUsable", "espesor"],
    atributosIniciales: {
      formatoComercial: "A4",
      ancho: 216,
      alto: 303,
  ...
  },
  {
    ...
    descripcion: "Imán flexible para heladera, souvenirs y piezas promocionales",
  ...
  },
  {
    ...
    camposTecnicos: [
      ...
      { key: "espesor", label: "Espesor", type: "number", unit: "mm", required: true },
      { key: "unidadesPorPack", label: "Unidades por pack", type: "number", required: true },
      { key: "grado", label: "Grado", type: "text", optional: true },
      { key: "adhesivo", label: "Adhesivo", type: "boolean", optional: true },
    ],
    dimensionesVariante: ["diametro", "espesor", "unidadesPorPack", "grado", "adhesivo"],
  ...
  },
  {
    ...
    descripcion: "Solapas, bolsillos y piezas compradas para armado de carpetas.",
    familia: "terminacion_editorial",
    ...
    dimensionesVariante: ["tipoComponente", "ancho", "alto", "material", "color"],
  ...
  },
  {
    ...
    unidadCompra: "unidad",
    camposTecnicos: [
      { key: "marca", label: "Marca", type: "text", options: ["Colop", "Trodat", "Nykon", "Otro"], required: true },
      { key: "modelo", label: "Modelo", type: "text", required: true },
      { key: "anchoPolimero", label: "Ancho de polímero", type: "number", unit: "mm", required: true },
      { key: "altoPolimero", label: "Alto de polímero", type: "number", unit: "mm", required: true },
      { key: "lineasTexto", label: "Líneas de texto (máx.)", type: "number", required: true },
      { key: "forma", label: "Forma", type: "text", options: ["Rectangular", "Redondo", "Ovalado"], optional: true },
      { key: "colorCarcasa", label: "Color de carcasa", type: "text", optional: true },
    ],
    dimensionesVariante: ["marca", "modelo", "anchoPolimero", "altoPolimero", "lineasTexto", "forma", "colorCarcasa"],
    requiredAtributos: ["marca", "modelo", "anchoPolimero", "altoPolimero", "lineasTexto"],
    atributosIniciales: {
      marca: "Colop",
      modelo: "Printer 30",
      anchoPolimero: 47,
  ...
  },
  {
    ...
    camposTecnicos: [
      ...
      { key: "lineasTexto", label: "Líneas de texto (máx.)", type: "number", required: true },
      { key: "forma", label: "Forma", type: "text", options: ["Rectangular", "Redondo", "Ovalado"], optional: true },
      { key: "material", label: "Material del mango", type: "text", options: ["Madera", "Plástico"], optional: true },
    ],
    dimensionesVariante: ["marca", "modelo", "anchoPolimero", "altoPolimero", "lineasTexto", "forma", "material"],
    requiredAtributos: ["marca", "modelo", "anchoPolimero", "altoPolimero", "lineasTexto"],
    atributosIniciales: {
      marca: "Trodat",
  ...
  },
  {
    ...
    camposTecnicos: [
      ...
      { key: "codigoRepuesto", label: "Código de repuesto", type: "text", required: true },
      { key: "modeloCompatible", label: "Modelo de sello compatible", type: "text", optional: true },
      { key: "colorTinta", label: "Color de tinta", type: "text", options: ["Negro", "Azul", "Rojo", "Verde", "Violeta", "Neutro", "MCI", "Bicolor"], required: true },
    ],
  ...
  },
  {
    ...
    camposTecnicos: [
      ...
      { key: "colorTinta", label: "Color de tinta", type: "text", options: ["Negro", "Azul", "Rojo", "Verde", "Violeta"], required: true },
      { key: "volumen", label: "Volumen", type: "number", unit: "ml", required: true },
      { key: "uso", label: "Uso", type: "text", options: ["General", "Telas"], optional: true },
    ],
  ...
  },
  {
    ...
    camposTecnicos: [
      ...
      { key: "color", label: "Color", type: "text", options: ["Rojo", "Verde", "Gris", "Otro"], required: true },
      { key: "espesor", label: "Espesor", type: "number", unit: "mm", required: true },
      { key: "ancho", label: "Ancho", type: "number", unit: "mm", required: true },
      { key: "alto", label: "Alto", type: "number", unit: "mm", required: true },
    ],

...
export const materiaPrimaTemplatesV1: MateriaPrimaTemplateDef[] = [
  ...
  },
  {
    ...
    camposTecnicos: [
      ...
      { key: "canalColor", label: "Canal color", type: "text", required: true },
    ],
    dimensionesVariante: ["canalColor"],
    requiredAtributos: ["tecnologiaCompatible", "canalColor"],
    atributosIniciales: {
  ...
  },
  {
    ...
    unidadCompra: "litro",
    camposTecnicos: [
      { key: "presentacion", label: "Presentación", type: "number", unit: "ml", required: true },
      { key: "tecnologiaCompatible", label: "Tecnología compatible", type: "text", required: true },
    ],
    dimensionesVariante: ["presentacion"],
    requiredAtributos: ["presentacion", "tecnologiaCompatible"],
    atributosIniciales: {
      presentacion: 1000,
  ...
  },
  {
    ...
    camposTecnicos: [
      { key: "ancho", label: "Ancho", type: "number", unit: "mm", required: true },
      { key: "alto", label: "Alto", type: "number", unit: "mm", required: true },
      { key: "materialBase", label: "Material base", type: "text", required: true },
    ],
    dimensionesVariante: ["ancho", "alto", "materialBase"],
    requiredAtributos: ["ancho", "alto", "materialBase"],
    atributosIniciales: {
      ancho: 210,
      alto: 297,
      materialBase: "polipropileno",
      espesor: 0.5,

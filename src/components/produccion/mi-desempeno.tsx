 ...
 * docs/metricas-equipo-operarios-estudio.md, F2). Tab del Panel general:
 * muestra exactamente los mismos números que ve el supervisor en el tab
 * Equipo, scoped al usuario logueado — tendencia contra uno mismo, nunca
 * contra compañeros. Ventana FIJA de 8 semanas (no usa el selector de
 * período del Panel). Más adelante los tabs se gatean por rol.
 */
...
export function TabMiDesempeno({ d }: { d: MiDesempenoPanel }) {
  ...
  return (
    <>
      <div style={{ fontSize: 12, color: "var(--muted-text)", marginBottom: 10 }}>
        Tu trabajo de las últimas {d.ventana.semanas} semanas (ventana fija, no usa el selector de período). Los mismos números que ve tu supervisor — acá no hay ranking.
      </div>

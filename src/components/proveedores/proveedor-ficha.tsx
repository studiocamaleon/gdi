...
function validatePayload(payload: ProveedorPayload) {
    ...
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-2xl font-semibold tracking-tight">
                {mode === "create" ? "Nuevo proveedor" : "Ficha de proveedor"}
              </h1>
            </div>
      ...
      <Card className="rounded-2xl border-border/70 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            Define la informacion base del proveedor y el telefono principal en
        ...
        <CardContent>
          <FieldGroup className="grid lg:grid-cols-2">
            <Field>
              <FieldLabel htmlFor="proveedor-nombre">Nombre del proveedor</FieldLabel>
              <Input
                id="proveedor-nombre"
